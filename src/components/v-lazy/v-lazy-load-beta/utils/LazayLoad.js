...
export default function(Vue) {
  return class Lazy {
    ...
    inserted(el, binding) {
      ...
      this.imgInstancePool.push(this.instanceImgItem(el, this.options, binding.value, scrollParent));
      scrollParent && this.isScroll && scrollParent.addEventListener('scroll', throttleScrollFn.bind(this), false);
      this.handleScroll();
    }
